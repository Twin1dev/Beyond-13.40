...
#include "GCN_BattleLab_GenericObject_Throw_classes.hpp"
#include "GCN_BattleLab_GenericObject_Throw_parameters.hpp"
...
void UGCN_BattleLab_GenericObject_Throw_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_BattleLab_GenericObject_Throw_C", "OnBurst");

	Params::GCN_BattleLab_GenericObject_Throw_C_OnBurst Parms{};
