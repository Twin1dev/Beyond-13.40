...
// WidgetBlueprintGeneratedClass FloatingInteraction_Indicator_Table.FloatingInteraction_Indicator_Table_C
// 0x00E0 (0x0368 - 0x0288)
class UFloatingInteraction_Indicator_Table_C final : public UFortEventLevelNavigationWidget
{
public:
...
public:
	void ExecuteUbergraph_FloatingInteraction_Indicator_Table(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FloatingInteraction_Indicator_Table_C">();
	}
	static class UFloatingInteraction_Indicator_Table_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFloatingInteraction_Indicator_Table_C>();
	}
};
