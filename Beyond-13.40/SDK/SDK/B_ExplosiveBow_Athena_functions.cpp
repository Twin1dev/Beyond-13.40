...
// float                                   Param_ProjectileVelocity                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FRotator                         OutRotation                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AB_ExplosiveBow_Athena_C::SetupProjectileVariables(struct FVector* StartLocation, struct FVector* InitialVelocity, float* Param_ProjectileVelocity, struct FRotator* OutRotation) const
{
	static class UFunction* Func = nullptr;
	...
	if (Param_ProjectileVelocity != nullptr)
		*Param_ProjectileVelocity = Parms.Param_ProjectileVelocity;
