...
// Parameters:
// class UFortItem*                        Param_RewardItem                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaSeasonItemRewardIcon_C::OnInitializeReward(const class UFortItem* Param_RewardItem, const TSoftObjectPtr<class UTexture2D>& RewardTexture, bool bHasAdditionalStylesToDisplay, int32 RewardLevel, bool bRequiresBattlePass)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_RewardItem = Param_RewardItem;
...
// Parameters:
// class UFortItem*                        Param_RewardItem                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaSeasonItemRewardIcon_C::SetupItemCardStyle(class UFortItem* Param_RewardItem)
{
	static class UFunction* Func = nullptr;
