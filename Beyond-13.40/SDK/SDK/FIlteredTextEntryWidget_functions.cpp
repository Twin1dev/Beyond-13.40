...
void UFilteredTextEntryWidget_C::OnTextChanged__DelegateSignature(const class FText& Text)
{
...
void UFilteredTextEntryWidget_C::OnSanitizedTextReady__DelegateSignature(const class FText& Text, bool BadText)
{
	static class UFunction* Func = nullptr;
