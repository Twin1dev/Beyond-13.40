...
public:
	...
	uint8                                         Pad_3E79[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E7A[0x20];                                    // 0x0028(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E7B[0x140];                                   // 0x0060(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E7C[0x30];                                    // 0x0028(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E7D[0x10];                                    // 0x0068(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E7E[0x77];                                    // 0x0119(0x0077)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E7F[0x8];                                     // 0x0198(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E80[0x110];                                   // 0x01A8(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E81[0x40];                                    // 0x0028(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E82[0x80];                                    // 0x0070(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E83[0x38];                                    // 0x0028(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E84[0x50];                                    // 0x0078(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E85[0x118];                                   // 0x00D8(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E86[0x50];                                    // 0x0028(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E87[0x7];                                     // 0x0169(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*> GroupChannels;                                     // 0x0170(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E88[0x60];                                    // 0x01C0(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E89[0xC0];                                    // 0x0028(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E8A[0x10];                                    // 0x00E8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E8B[0x60];                                    // 0x0028(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E8C[0x10];                                    // 0x0080(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E8D[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3E8E[0x140];                                   // 0x0028(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
