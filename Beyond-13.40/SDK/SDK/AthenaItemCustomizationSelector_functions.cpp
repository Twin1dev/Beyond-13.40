...
// Parameters:
// EAthenaCustomizationCategory            Param_Index                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UMaterialInstance*                OverrideImage                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
class UMaterialInstance* UAthenaItemCustomizationSelector_C::GetCategoryImage(EAthenaCustomizationCategory Param_Index, class UMaterialInstance* OverrideImage)
{
	static class UFunction* Func = nullptr;
