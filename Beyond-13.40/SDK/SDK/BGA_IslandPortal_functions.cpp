...
void ABGA_IslandPortal_C::IsBeingInteractedWith__DelegateSignature(bool IsInteracting)
{
	...
	Params::BGA_IslandPortal_C_IsBeingInteractedWith__DelegateSignature Parms{};
...
void ABGA_IslandPortal_C::UpdateLocalPlayerLookingAtScreen__DelegateSignature(bool bPlayerLookingAtScreen)
{
	...
	Params::BGA_IslandPortal_C_UpdateLocalPlayerLookingAtScreen__DelegateSignature Parms{};
...
void ABGA_IslandPortal_C::NotifyTeleportedPlayerPawn(class AFortPlayerPawn* Param_PlayerPawn, bool bTeleportedToIslandStart)
{
	static class UFunction* Func = nullptr;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                           Param_VehicleActor                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_IslandPortal_C::NotifyTeleportedVehicle(class AActor* Param_VehicleActor)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_VehicleActor = Param_VehicleActor;
...
// Parameters:
// class AActor*                           Param_OverlapActor                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_IslandPortal_C::StartTeleport(class AActor* Param_OverlapActor)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_OverlapActor = Param_OverlapActor;
...
void ABGA_IslandPortal_C::StartTeleportByInteractionOnServer(class AActor* Param_OverlapActor)
{
	static class UFunction* Func = nullptr;
