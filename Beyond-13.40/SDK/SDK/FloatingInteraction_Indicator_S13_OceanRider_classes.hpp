...
// WidgetBlueprintGeneratedClass FloatingInteraction_Indicator_S13_OceanRider.FloatingInteraction_Indicator_S13_OceanRider_C
// 0x0090 (0x0318 - 0x0288)
class UFloatingInteraction_Indicator_S13_OceanRider_C final : public UFortEventLevelNavigationWidget
{
public:
...
public:
	void ExecuteUbergraph_FloatingInteraction_Indicator_S13_OceanRider(int32 EntryPoint);
	void Construct();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FloatingInteraction_Indicator_S13_OceanRider_C">();
	}
	static class UFloatingInteraction_Indicator_S13_OceanRider_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFloatingInteraction_Indicator_S13_OceanRider_C>();
	}
};
