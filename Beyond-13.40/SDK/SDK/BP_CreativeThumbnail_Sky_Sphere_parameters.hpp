...
struct BP_CreativeThumbnail_Sky_Sphere_C_UserConstructionScript final
{
public:
...
struct BP_CreativeThumbnail_Sky_Sphere_C_UpdateSunDirection final
{
public:
	bool                                          CallFunc_Less_FloatFloat_ReturnValue;              // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_60FB[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
struct BP_CreativeThumbnail_Sky_Sphere_C_RefreshMaterial final
{
public:
	...
	uint8                                         Pad_60FC[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_60FD[0x3];                                     // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
