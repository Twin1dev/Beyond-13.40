...
void ABLGA_BattleLab_Parent_C::OnStartedMoving__DelegateSignature()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BLGA_BattleLab_Parent_C", "OnStartedMoving__DelegateSignature");
...
// Parameters:
// EBL_HeldState                           Param_HeldState                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABLGA_BattleLab_Parent_C::OnHeldObjectStateChangedClient(EBL_HeldState Param_HeldState)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_HeldState = Param_HeldState;
...
// Parameters:
// struct FVector                          ReplicatedVelocity                                     (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
