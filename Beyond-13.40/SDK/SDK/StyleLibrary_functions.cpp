...
// Parameters:
// int32                                   HomeBaseRating                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   DifficultyLevel                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FLinearColor                     DifficultyColor                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UStyleLibrary_C::Get_Conning_Color_From_Homebase_Rating(int32 HomeBaseRating, int32 DifficultyLevel, class UObject* __WorldContext, struct FLinearColor* DifficultyColor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StyleLibrary_C", "Get Conning Color From Homebase Rating");

	Params::StyleLibrary_C_Get_Conning_Color_From_Homebase_Rating Parms{};

	Parms.HomeBaseRating = HomeBaseRating;
