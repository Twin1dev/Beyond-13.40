...
// Function NitrogenRuntime.FortAthenaMutator_Nitrogen.OnRep_NitrogenSpawnInfo
// (Final, Native, Private)

void AFortAthenaMutator_Nitrogen::OnRep_NitrogenSpawnInfo()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_Nitrogen", "OnRep_NitrogenSpawnInfo");
...
void UFortCheatManager_Nitrogen::TeleportToNitrogenRespawnActor(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Nitrogen::TeleportToNitrogenSpawnActor(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Nitrogen::TeleportToSquadStartAtIndex(const int32 Param_Index, const struct FFortSquadStartSearchParamData& SearchParam, class FString* TeleportReasonString)
{
	static class UFunction* Func = nullptr;
