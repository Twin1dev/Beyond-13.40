...
// Parameters:
// struct FHitResult                       Param_WaterHit                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
void AB_Prj_Bullet_Sniper_C::OnSniperTraceWaterHit(const struct FHitResult& Param_WaterHit, class AFortWaterBodyActor* WaterBody)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_WaterHit = std::move(Param_WaterHit);
