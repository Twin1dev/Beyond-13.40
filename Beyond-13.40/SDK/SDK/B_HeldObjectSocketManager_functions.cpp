...
// TArray<struct FGameplayTagContainer>    Param_CurrentTags                                      (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
...
void AB_HeldObjectSocketManager_C::VerifyHeldObjectTags(TArray<struct FGameplayTagContainer>& CorrectTags, TArray<struct FGameplayTagContainer>& Param_CurrentTags, bool OrderMatters, bool* IsValidMatch)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CurrentTags = std::move(Param_CurrentTags);
	Parms.OrderMatters = OrderMatters;

	UObject::ProcessEvent(Func, &Parms);

	CorrectTags = std::move(Parms.CorrectTags);
	Param_CurrentTags = std::move(Parms.Param_CurrentTags);
