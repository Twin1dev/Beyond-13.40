...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_bShouldConvertExcessHealthToShields              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UGA_Creative_OnKillSiphon_C::AddShields(bool Param_bShouldConvertExcessHealthToShields, float ShieldToAdd, bool* bAddedShields, float* ShieldAdded)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_bShouldConvertExcessHealthToShields = Param_bShouldConvertExcessHealthToShields;
