...
// TArray<struct FWaterWaveParams>         Param_Waves                                            (Parm, OutParm, HasGetValueTypeHash)

void ABP_Gerstner_Wave_Controller_C::Generate_Spectrum(const struct FWaveSpectrumSettings& Spectrum, TArray<struct FWaterWaveParams>* Param_Waves)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Waves != nullptr)
		*Param_Waves = std::move(Parms.Param_Waves);
}
