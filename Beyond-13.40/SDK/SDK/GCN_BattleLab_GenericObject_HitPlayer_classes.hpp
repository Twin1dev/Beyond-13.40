...
// BlueprintGeneratedClass GCN_BattleLab_GenericObject_HitPlayer.GCN_BattleLab_GenericObject_HitPlayer_C
// 0x0008 (0x01C0 - 0x01B8)
class UGCN_BattleLab_GenericObject_HitPlayer_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_BattleLab_GenericObject_HitPlayer_C">();
	}
	static class UGCN_BattleLab_GenericObject_HitPlayer_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_BattleLab_GenericObject_HitPlayer_C>();
	}
};
