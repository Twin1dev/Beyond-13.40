...
void ABGA_Athena_FlopperSpawn_World_C::SpawnFromExplosion(class AActor* Param_Instigator, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
void ABGA_Athena_FlopperSpawn_World_C::ExplosionQuestProgress(class AActor* Param_Instigator, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
