...
void ABGA_Petrol_Pickup_C::SetHeldItemInfo(TScriptInterface<class IFortInventoryOwnerInterface> InventoryInterface, const struct FGuid& Guid, class AFortWeapon* Param_WeaponAttachedTo)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPawn*                        Param_ExplodeInstigator                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_Petrol_Pickup_C::SpawnCurieFireballs(class AFortPawn* Param_ExplodeInstigator)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ExplodeInstigator = Param_ExplodeInstigator;
