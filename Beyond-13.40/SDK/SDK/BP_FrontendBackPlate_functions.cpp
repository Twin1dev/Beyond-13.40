...
void ABP_FrontendBackPlate_C::SetBackgroundTexture(class UTexture* Texture, class UMaterialInterface* Material, class UMaterialInterface* Param_PreBlurMaterial)
{
	static class UFunction* Func = nullptr;
...
void ABP_FrontendBackPlate_C::HasUIColorOverride(bool* Param_HasUIColorOverride)
{
	...
	if (Param_HasUIColorOverride != nullptr)
		*Param_HasUIColorOverride = Parms.Param_HasUIColorOverride;
}
