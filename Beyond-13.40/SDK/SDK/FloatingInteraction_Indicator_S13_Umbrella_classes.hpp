...
// WidgetBlueprintGeneratedClass FloatingInteraction_Indicator_S13_Umbrella.FloatingInteraction_Indicator_S13_Umbrella_C
// 0x00E0 (0x0368 - 0x0288)
class UFloatingInteraction_Indicator_S13_Umbrella_C final : public UFortEventLevelNavigationWidget
{
public:
	...
	struct FSlateColor                            Bang;                                              // 0x0318(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateColor                            NoBang;                                            // 0x0340(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)

public:
	void ExecuteUbergraph_FloatingInteraction_Indicator_S13_Umbrella(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FloatingInteraction_Indicator_S13_Umbrella_C">();
	}
	static class UFloatingInteraction_Indicator_S13_Umbrella_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFloatingInteraction_Indicator_S13_Umbrella_C>();
	}
};
