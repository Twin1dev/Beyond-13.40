...
void UGA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C::OnProjectileSpawned(class AFortProjectileBase* Param_SpawnedProjectile)
{
	static class UFunction* Func = nullptr;
