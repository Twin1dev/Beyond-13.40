...
class UGCN_Athena_PetrolPickup_HitPlayer_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_PetrolPickup_HitPlayer_C">();
	}
	static class UGCN_Athena_PetrolPickup_HitPlayer_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_PetrolPickup_HitPlayer_C>();
	}
};
