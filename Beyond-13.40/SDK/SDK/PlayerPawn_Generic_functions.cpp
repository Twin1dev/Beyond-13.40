...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPawn*                        Param_Instigator                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void APlayerPawn_Generic_C::PlayHitSound(class AFortPawn* Param_Instigator, class AActor* Damage_Causer)
{
	static class UFunction* Func = nullptr;
