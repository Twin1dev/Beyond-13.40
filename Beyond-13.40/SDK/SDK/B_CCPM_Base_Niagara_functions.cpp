...
void AB_CCPM_Base_Niagara_C::GetIsDriving(bool* Param_IsDriving)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::Set_Niagara_System_User_Variable__Float_(class FName Param_Name, float Value)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::Set_Niagara_System_User_Variable__Int_(class FName Param_Name, int32 Value)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::Set_Niagara_System_User_Variable__Vector_(class FName Param_Name, const struct FVector& Value)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::Set_Niagara_System_User_Variable__Color_(class FName Param_Name, const struct FLinearColor& Value)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::Set_Niagara_System_User_Variable__Bool_(class FName Param_Name, bool Value)
{
	static class UFunction* Func = nullptr;
...
void AB_CCPM_Base_Niagara_C::GetIsFrontEnd(bool* Param_IsInFrontEnd)
{
	static class UFunction* Func = nullptr;
