...
// BlueprintGeneratedClass S13_MainRoom_ToUmbrella.SequenceDirector_C
// 0x0008 (0x0038 - 0x0030)
class S13_MainRoom_ToUmbrella::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BlueprintGeneratedClass S13_MainRoom_ToUmbrella.SequenceDirector_C", true, "SequenceDirector_C">();
	}
	static class S13_MainRoom_ToUmbrella::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S13_MainRoom_ToUmbrella::USequenceDirector_C>();
	}
};
