...
public:
	...
	uint8                                         Pad_46E5[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_46E6[0x40];                                    // 0x0058(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_46E7[0x3E0];                                   // 0x00B8(0x03E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_46E8[0x8];                                     // 0x04C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46E9[0xA8];                                    // 0x0050(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46EA[0x98];                                    // 0x00F8(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_46EB[0x140];                                   // 0x0030(0x0140)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_46EC[0x8];                                     // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLastLocationGatherInfo>        LastGatherLocations;                               // 0x0180(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_46ED[0x8];                                     // 0x0190(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UReplicationGraphNode*>          ConnectionGraphNodes;                              // 0x0198(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                       // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_46EE[0x80];                                    // 0x01B0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46EF[0xE8];                                    // 0x0050(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46F0[0x30];                                    // 0x00F8(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46F1[0x50];                                    // 0x00F8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46F2[0x48];                                    // 0x00F8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46F3[0x1E0];                                   // 0x0050(0x01E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_46F4[0x10];                                    // 0x0058(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46F5[0x18];                                    // 0x00F8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_46F6[0x18];                                    // 0x0060(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
