...
// class AController*                      Param_Instigator                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_ShootingTarget_Master_C::Impact_Audio(int32 Check_for_Positive_Score, class AController* Param_Instigator)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_InJumpUpPosition                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AB_ShootingTarget_Master_C::Hop(bool Param_InJumpUpPosition)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_InJumpUpPosition = Param_InJumpUpPosition;
...
// Parameters:
// bool                                    MinigameJustStartedOrStopped                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    Param_CanPopUp                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AB_ShootingTarget_Master_C::CanPopUp(bool MinigameJustStartedOrStopped, bool* Param_CanPopUp)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_CanPopUp != nullptr)
		*Param_CanPopUp = Parms.Param_CanPopUp;
}
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UStaticMeshComponent*             Param_StaticMeshComponent                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_ShootingTarget_Master_C::PrepareChosenTarget(class UStaticMeshComponent* Param_StaticMeshComponent, class UPrimitiveComponent* WeakPointComponent_1, class UPrimitiveComponent* WeakPointComponent2)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_StaticMeshComponent = Param_StaticMeshComponent;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_MinigameIsRunning                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AB_ShootingTarget_Master_C::MinigameIsRunning(bool* Param_MinigameIsRunning)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_MinigameIsRunning != nullptr)
		*Param_MinigameIsRunning = Parms.Param_MinigameIsRunning;
}
